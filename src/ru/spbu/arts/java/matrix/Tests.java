...
public class Tests {
    public static void main(String[] args) {
        ...
        matrica.print();
        System.out.println("----------------------------");
        Matrix22 matrica_kak_massiv = new Matrix22(new double [][] {{100, 2},{3, 400}});
        matrica_kak_massiv.print();
        System.out.println(matrica.getMatrix22());
        System.out.println(matrica_kak_massiv.getMatrix22());
        System.out.println("----------------------------");
